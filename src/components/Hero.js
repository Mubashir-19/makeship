...
const Hero = () => {
  return (
    <header className="relative bg-background-dark text-white pt-32 pb-20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <div className="inline-flex items-center space-x-2 mb-6">
              ...
              <span className="text-primary text-xs font-semibold tracking-widest uppercase">PREMIUM PRODUCT DESIGN & DEVELOPMENT AGENCY</span>
            </div>
          ...
          <div className="lg:mt-12 space-y-16">
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-8">
              <div>
                <div className="text-4xl font-display font-bold text-white mb-1">99%</div>
                <div className="text-sm text-gray-500">Customer satisfaction rate</div>
              </div>
              <div>
                <div className="text-4xl font-display font-bold text-white mb-1">65%+</div>
              ...
              <div>
                <div className="text-4xl font-display font-bold text-white mb-1">10M+</div>
      ...
      <div className="absolute -bottom-[1px] left-0 w-full text-background-light dark:text-background-dark">
        <svg className="block w-full h-16 sm:h-24 fill-current" preserveAspectRatio="none" viewBox="0 0 1440 74" xmlns="http://www.w3.org/2000/svg">
